SELECT b.project_name
     ...
     , CASE
           WHEN b.team = 'nais' THEN 'Plattform'
           WHEN b.team = 'nada' THEN 'Dataplattform'
...
GROUP BY project_name, project_id, env, tenant, team, dato, service_description, sku_id, sku_description, app, cost_category, namespace